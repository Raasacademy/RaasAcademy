                  ...
                  <div className="col-lg-6">
                     <div className="choose__content-four">
                        <div className="section__title mb-20">
                           <span className="sub-title" style={{ backgroundColor: '#2A62FF', color: '#FFFFFF' }}>Why Choose Us</span>
                        ...
                        <ul className="about__info-list list-wrap">
                           <li className="about__info-list-item">
                              <i className="flaticon-angle-right" style={{ backgroundColor: '#2A62FF', color: '#FFFFFF' }}></i>
                        ...
                        <Link href="/login" className="btn arrow-btn btn-four" style={{ backgroundColor: '#2A62FF', color: '#FFFFFF' }}>Start Free Trial<BtnArrow /></Link>
                     </div>
                  </div>
               </div>
            </div>
