            ...
            <div className="row justify-content-center">
               <div className="col-lg-6">
                  <div className="section__title text-center mb-40">
                     <span className="sub-title" style={{ backgroundColor: '#2A62FF', color: '#FFFFFF' }}>News & Blogs</span>
                  ...
                  <div key={item.id} className="col-xl-3 col-md-6">
                     <div className="blog__post-item shine__animate-item">
                        <div className="blog__post-thumb">
                           ...
                           <Link href="/blog" className="post-tag" style={{ backgroundColor: '#2A62FF', color: '#FFFFFF' }}>{item.tag}</Link>
                        </div>
