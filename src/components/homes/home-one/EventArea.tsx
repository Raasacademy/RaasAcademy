                        ...
                        <div className="col-30">
                            <div className="event__content">
                                <div className="section__title mb-20">
                                    <span className="sub-title" style={{ backgroundColor: '#2A62FF', color: '#FFFFFF' }}>Upcoming Events</span>
                                ...
                                <div className="tg-button-wrap">
                                    <Link href="/events" className="btn arrow-btn" style={{ backgroundColor: '#2A62FF', color: '#FFFFFF' }}>See All Events <BtnArrow /></Link>
                                </div>
                            </div>
                        </div>
                                        ...
                                        <div key={item.id} className="col-lg-4 col-md-6">
                                            <div className="event__item shine__animate-item">
                                                ...
                                                <div className="event__item-content">
                                                    <span className="date" style={{ backgroundColor: '#2A62FF', color: '#FFFFFF' }}>{item.date}</span>
