...
const FooterOne = ({ style, style_2 }: any) => {
   return (
      <footer className={`footer__area ${style_2 ? "footer__area-five" : style ? "footer__area-two" : ""}`} style={{ backgroundColor: '#2A62FF', color: '#FFFFFF' }}>
               ...
               <div className="row">
                  ...
                  <div className="col-xl-3 col-lg-4 col-md-6">
                     <div className="footer__widget">
                        <h4 className="footer__widget-title" style={{ color: 'white' }}>Get In Touch</h4>
                        <div className="footer__contact-content">
                           <p style={{ color: 'white' }}>when an unknown printer took <br /> galley type and scrambled</p>
         ...
         <div className={`footer__bottom ${style_2 ? "footer__bottom-four" : ""}`} style={{ backgroundColor: '#FFFFFF', color: '#FFFFFF' }}>
            <div className="container">
